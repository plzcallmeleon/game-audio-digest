...
// ============================================================================
// Game Audio Digest — Prepare Digest
// ============================================================================
// Gathers everything the LLM needs to produce a digest:
// - Fetches the central feeds (tweets + podcasts + blogs + reddit)
...
async function main() {
  ...
  const [feedX, feedPodcasts, feedBlogs, feedReddit] = await Promise.all([
  ...
  if (!feedX) errors.push('Could not fetch tweet feed (X is optional)');
  ...
  //
  // If the user has a custom prompt at ~/.game-audio-digest/prompts/<file>,
  ...
  const output = {
    ...
    stats: {
      ...
      redditPosts: feedReddit?.reddit?.length || 0,
